        ...
        <div className="flex justify-between items-center">
          ...
          <div className="md:hidden flex items-center">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className={`relative flex flex-col items-center justify-center w-[36px] h-[36px] rounded-md shadow-md focus:outline-none transition-colors ${scrolled || !isHome ? "bg-[#0A1F44]" : "bg-black/30 backdrop-blur-md"
                }`}
            >
              <motion.span
